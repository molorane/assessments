...
public class BalancedParentheses{
	private static String getPermuations(final int n){
		return (
			//set the ground recursive clauses
			n==0?"":
			n==1?"()":
			"("+getPermuations(n-2)+"); "+"()"+getPermuations(n-1)
		);
	}
	
	public static void main(String ... args){
		System.out.println(getPermuations(4));
	}
}

/*
Total increasing or decreasing numbers up to a power of 10
2721790% of 125156 of 674GiacomoSorbi
Java
